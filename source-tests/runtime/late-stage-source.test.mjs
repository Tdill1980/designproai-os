...
test("released claimant archives the seal, the stamped proof and the QC certificate", () => {
  ...
  assert.match(claimantSource, /const expectedStamps = \(authorized\.zipIncludesSourceViews \? 10 : 3\) \+ \(stampReceipt\.receipt\?\.stampedProductionPanelProof \? 1 : 0\);/);
  assert.match(claimantSource, /counts\.stamp !== expectedStamps/);
