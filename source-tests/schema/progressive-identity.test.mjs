...
const sql=readFileSync(join(root,"migrations/20260806180400_designpro_progressive_identity.sql"),"utf8").toLowerCase();
const blockers=JSON.parse(readFileSync(join(workspace,"worktracks/runtime_closure/contracts/standalone-refactor-blockers.json"),"utf8"));
...
assert.ok(blockers.contract.startsWith("designpro.standalone-refactor-blockers."));
