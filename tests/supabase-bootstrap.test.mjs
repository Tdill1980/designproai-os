...
test('fresh bootstrap contains one ordered eighty-seven-migration chain', () => {
  assert.equal(migrationNames.length, 87);
  assert.deepEqual(
    ...
    [
      ...
      '20260829230100',
      '20260830233000',
      '20260831103000', '20260902120000', '20260903000000',
    ],
  );
});
