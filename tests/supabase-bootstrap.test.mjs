...
test('fresh bootstrap contains one ordered one-hundred-thirty-four-migration chain', () => {
  assert.equal(migrationNames.length, 134);
  assert.deepEqual(
    ...
    [
      ...
      '20260920011000', '20260920022906', '20260920025200', '20260920042000', '20260920113000',
    ],
  );
});
