...
test('fresh bootstrap contains one ordered one-hundred-twelve-migration chain', () => {
  assert.equal(migrationNames.length, 112);
  assert.deepEqual(
    ...
    [
      ...
      '20260913000000', '20260914160000', '20260914200000',
    ],
  );
});
