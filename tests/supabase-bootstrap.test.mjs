...
test('fresh bootstrap contains one ordered one-hundred-thirty-two-migration chain', () => {
  assert.equal(migrationNames.length, 132);
  assert.deepEqual(
    ...
    [
      ...
      '20260920011000', '20260920022906', '20260920113000',
    ],
  );
});
