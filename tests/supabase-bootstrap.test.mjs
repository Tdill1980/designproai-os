...
test('fresh bootstrap contains one ordered one-hundred-thirty-three-migration chain', () => {
  assert.equal(migrationNames.length, 133);
  assert.deepEqual(
    ...
    [
      ...
      '20260920011000', '20260920022906', '20260920025200', '20260920113000',
    ],
  );
});
