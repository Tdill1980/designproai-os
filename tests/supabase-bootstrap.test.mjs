...
test('fresh bootstrap contains one ordered one-hundred-migration chain', () => {
  assert.equal(migrationNames.length, 102);
  assert.deepEqual(
    ...
    [
      ...
      '20260908201216',
      '20260909062205',
      '20260910070849', '20260911120000', '20260911150000', '20260911190000', '20260911200000',
    ],
  );
});
