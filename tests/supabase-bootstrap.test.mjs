...
test('fresh bootstrap contains one ordered one-hundred-fourteen-migration chain', () => {
  assert.equal(migrationNames.length, 114);
  assert.deepEqual(
    ...
    [
      ...
      '20260913000000', '20260914160000', '20260914200000', '20260914230000', '20260915010000',
    ],
  );
});
