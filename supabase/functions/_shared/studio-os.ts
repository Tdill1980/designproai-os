 ...
 *
 *  Proprietary studio/render prompt constants — a TRADE SECRET of
 *  RestylePro / LoopMighty Software Development LLC, part of the DesignIQ™ /
 *  LiftIQ Engine™ architecture (patent-pending system & methods).
 *
 ...
 */
/**
 * STUDIO OS — The single source of truth for all render environments.
 * Every render call imports this. No inline studio strings anywhere.
 * This is the kernel — it never changes between camera angles.
 *
 * DesignIQ NeuralNetwork v3.2 — Bright photorealistic showroom studio.
 * Identity-first prompt. Bright, clean, color-accurate editorial quality.
 * DO NOT MODIFY without Trish approval.
 */
...
export const STUDIO_REINFORCEMENT = `
STUDIO LOCK:
...
// ============================================================================
// LIGHT STUDIO — White/bright environment for light-mode renders.
// Mirrors the dark-mode kernel above with a bright white cyclorama.
// Uses positive-instruction language only (matches dark-mode style; avoids
// negative-instruction stacking per Gemini best practices in CLAUDE.md).
// Existing dark-mode exports above are unchanged.
// ============================================================================

export const LIGHT_STUDIO_ENVIRONMENT = `
You are a professional automotive photographer shooting for a luxury car brand campaign.
Every shot is technically perfect — bright, clean, color-accurate, and photorealistic.
...
export const LIGHT_STUDIO_REINFORCEMENT = `
