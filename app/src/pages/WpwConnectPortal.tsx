  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Past-order dashboard, one-click reorder, and a customer quoting tool with WPW wholesale pricing baked in — for WePrintWraps shops. Custom wrap designs from $250."
        />
      ...
      <div className="min-h-screen bg-black text-white">
        <div className="max-w-[680px] mx-auto px-5 sm:px-8 py-10">
          ...
          <div className="text-center mb-10">
            ...
            <div className="text-[#666] text-xs mt-3">For WePrintWraps shops. No card to activate the dashboard.</div>
          </div>
          ...
          <div className="mb-10">
            <div className="text-[#00C7FF] text-xs font-bold tracking-[2px] uppercase mb-3">
              Perk #1 · AI Wrap Design · $250 per design
            </div>
            <h2 className="text-xl sm:text-2xl font-bold leading-tight mb-4">
              A custom wrap design, done in minutes.
            </h2>
          ...
          <div className="mb-10">
            ...
            <ul className="text-[#ccc] text-base leading-[1.8] list-disc pl-6 mb-4 space-y-1">
              ...
              <li>
                <strong className="text-[#00C7FF]">Plus AI wrap design</strong> — $250 per custom design (3 revisions, 7 view
                angles, a 3D proof), ordered straight from the same account.
              </li>
            </ul>
          ...
          <div className="bg-[rgba(0,199,255,0.06)] border border-[rgba(0,199,255,0.25)] rounded-xl p-5 sm:p-6 mb-8">
            <div className="text-[#00C7FF] text-[11px] font-bold tracking-[2px] uppercase mb-2">
              Everything in your Shop Engine Dashboard
            </div>
            <div className="text-white text-base leading-relaxed font-semibold">
              Past-order view &middot; One-click reorder &middot; Customer quoting tool with WPW wholesale pricing baked in.
            </div>
            <div className="text-[#aaa] text-[13px] mt-2">
              No card to activate. Custom AI wrap designs $250 each; Production Packs $299 when you&rsquo;re ready to print.
            </div>
          </div>
