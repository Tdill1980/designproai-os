...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
              ...
              <div className="space-y-5 order-2 lg:order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  {isAuthed ? (
                    ...
                    <Button asChild size="lg" variant="gradient" className="text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6">
                      <Link to="/try-design">
                        Design Your Wrap — $250 <ArrowRight className="w-5 h-5 ml-2" />
                      </Link>
                    </Button>
                  )}
                ...
                {!isAuthed && (
                  <p className="text-xs text-white/40">
                    One custom wrap design · 3 revisions · 7 view angles · 3D proof · No subscription
                  </p>
                )}
      ...
      {/* WrapGuru — customer service, instant quotes, brand/product pitching (wpw-sales-chat) */}
