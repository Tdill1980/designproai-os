    ...
    try {
      ...
      if (data.user) {
        ...
        if (isWpwFlow) {
          ...
          toast.success("Account created. Use code WELCOME10 for 10% off any plan. Check your email to confirm.");
        }
        navigate(returnTo);
      }
    } catch (error: any) {
          ...
          <div className="bg-card border border-border rounded-lg p-8">
            ...
            <div className="mb-5 rounded-md border border-cyan-500/30 bg-cyan-500/5 p-3 text-xs leading-relaxed">
              ...
              <div className="text-muted-foreground">
                ...
                we'll auto-link your account — your full WPW order history will be
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <p className="text-[11px] text-center text-muted-foreground">
                Create your account, then pick a plan or buy a single design ($250)
              </p>
            </form>
