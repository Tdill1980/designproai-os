...
const FAQPricing = () => (
  <SEOFAQPage
    title="Pricing & Plans FAQ - Vehicle Wrap Software Pricing | RestyleProAI™"
    headline="Pricing & Plans FAQ"
    description="Learn about RestyleProAI™ subscription plans, render allowances, extra render pricing, and billing. Plans for every wrap shop size - no contracts, cancel anytime."
