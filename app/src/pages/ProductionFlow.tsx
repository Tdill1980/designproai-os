...
import { VehicleTypeSelector, isNonStandardVehicle, type VehicleType } from "@/components/tools/VehicleTypeSelector";
import { getDesignProFunctionForType } from "@/components/tools/legacyRenderFunctions";
