...
import { Home, Factory, Grid3X3, Image, Brain } from "lucide-react";
...
// DesignProOS navigation stays on the standard tools; ShopFlow owns its tenant navigation.
const TABS = [
  ...
  { label: "WallPro", route: "/printpro/wallpro", icon: Image, match: ["/printpro/wallpro", "/wallpro"], kind: "link" as const },
  { label: "VehiclePro", route: "/designpro/create", icon: Brain, match: ["/designpro/create"], kind: "link" as const },
