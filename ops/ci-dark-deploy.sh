...
if [[ -L /opt/designproai-os/current ]] && \
  ...
  # (ATLAS_PANEL_FINISH, ATLAS_TOPOLOGY, ATLAS_CALL1_GRAPH, ATLAS_FIELD_FIRST,
  ...
  if [[ -n ${ATLAS_PANEL_FINISH:-}${ATLAS_TOPOLOGY:-}${ATLAS_CALL1_GRAPH:-}${ATLAS_FIELD_FIRST:-}${ATLAS_HERO_FIRST:-}${ATLAS_ELEMENT_GRAPH:-}${ATLAS_PANEL_PROOF:-} ]]; then
