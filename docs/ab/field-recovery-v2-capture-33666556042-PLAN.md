...
Contract `designpro.atlas-field-territories.v2`, topology `field-thirds-v2`, GENIE manifest `766258a022b2a2da16007affc37ade77ee0af79f7b25f4f74a2039821de75b96` (measured). Thirds: third 1 y 0–1365 (1365px) = driver · third 2 y 1365–2730 (1365px) = passenger · third 3 y 2730–4096 (1366px) = roof/hood/front/rear. Rear sits under the front. Centre scale 12.65 px/in.
