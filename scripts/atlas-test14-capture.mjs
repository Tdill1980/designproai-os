...
const { FIELD_TOPOLOGY } = require("../runtime/atlas-field-territories.cjs");
...
async function main() {
  ...
  // `topology` is what selects the field branch in atlasEdgeRequestBody, so the
  // replay carries the same value the persisted revision recorded.
  const manifest = { topology: FIELD_TOPOLOGY, canvas: FIXTURE.canvas,
    installerMap: { noseEdge: FIXTURE.noseEdge }, zones: FIXTURE.zones };
